...
First, in (Table \@ref(tab:winter)) we found that firefighters were significantly more likely to be injured or killed at residential and commercial/industrial fires. Although these results could be explained by these types of fires being more common, it may also be due to the proper firefighter responses to these dispatch alarms. Firefighters are expected to perform earch-and-rescue operations for these types of fires which may expose them to very hazardous situations and risks. 
...
Third, (Figure \@ref(fig:fig3)) and (Figure \@ref(fig:fig4)), 
